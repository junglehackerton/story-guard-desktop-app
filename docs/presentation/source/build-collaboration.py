"""Build the standalone remote collaboration deck using bundled licensed fonts."""
from pathlib import Path
import base64
import html

root = Path(__file__).resolve().parents[1]
source = (root / 'source/collaboration-slides.html').read_text()
...
output = root / 'story-guard-collaboration.html'
